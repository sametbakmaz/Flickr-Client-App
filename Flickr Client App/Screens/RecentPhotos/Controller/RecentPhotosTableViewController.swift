...
class RecentPhotosTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    private func searchPhotos(with text: String) {
        guard let url = URL(string:
                                "https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=a962323dd63d4fd884b75fdf34bf7e76&text=\(text)&format=json&nojsoncallback=1&extras=description,owner_name,icon_server,url_n,url_z") else { return }
        let request = URLRequest(url: url)
